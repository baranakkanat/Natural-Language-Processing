...
This analysis is based on 2,361 commitments extracted from the explanations for answers given by the Llama and Qwen models to questions 121–270 of the ARC-Challenge dataset. Nine questions (IDs: 149, 156, 159, 163, 175, 183, 206, 225 and 255) were excluded from the analysis based on the annotators' judgment of relevance. To assess the consistency of each model, we asked the respective model whether it agreed with the commitments extracted from its own explanations.
